        ...
        <form className="max-w-xl mx-auto p-2 sm:w-72">
            ...
            <div className="relative">
                ...
                <input
                    type="search"
                    id='default-search'
                    className='block w-full p-4 ps-10 text-sm rounded-lg bg-glass focus:ring-blue-500 focus:border-blue-500 
                ...
                focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 bg-gradient-to-r from-cyan-900 to-blue-900
